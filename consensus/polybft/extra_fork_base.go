...
const ForkHandlerExtra forkmanager.ForkHandlerName = "extra"
const ForkHandlerExtraAdditional forkmanager.ForkHandlerName = "extra_additional"

type IExtraAdditionalHandler interface {
...
type IExtraHandler interface {
	...
	ValidateAdditional(extra *Extra, header *types.Header, logger hclog.Logger) error
}
...
func (e *ExtraHandlerBase) ValidateAdditional(extra *Extra, header *types.Header, logger hclog.Logger) error {
	return nil
}

type ExtraHandlerAdditionalBase struct {
}

func (i *ExtraHandlerAdditionalBase) GetIbftExtraClean(extra *Extra) *Extra {
	return &Extra{
